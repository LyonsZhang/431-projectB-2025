...
- the entire Project B [Plan page](plan.qmd), and
- the [Examples material](examples.qmd) related to the Project B Plan, specifically the Project B Plan template.
...
Your Project B will use the 2025 version of the analytic data from [County Health Rankings](https://www.countyhealthrankings.org/) (**CHR 2025**) for most of the work^[In Analysis 3, we will also use **CHR 2019** as you'll see]. Some prior CHR data has been part of our course, but you'll obtain, clean and manage a new data set for Project B.
...
- [the 2025 Technical Document](https://www.countyhealthrankings.org/sites/default/files/media/document/2025%20CHRR%20Technical%20Document_1.pdf)

In addition, when building the Codebook as part of your [Project B Plan](plan.qmd), you'll use [this CHR 2025 Measures link](https://www.countyhealthrankings.org/health-data/county-health-rankings-measures) to obtain further details on the variables you select. 

# Developing the Data: Data Tasks

Obtaining and cleaning your data takes a little while, but you can start at any time. First, in broad terms, here are the six data tasks you need to complete in order to build your Project B Plan.
...
1. You will need to write a sentence or two in your Project B Plan describing the reason for your selection of states, so you should have one.
...
Each of the variables you select should be of some interest to you on its own, in terms of either providing a health outcome of interest, or potentially providing useful information about a feature of the county that might relate to that health outcome. As part of the selection process, you should be developing appropriate **research questions** that lead to the identification of smart measures of interest (from those available) for predictors and outcomes in our Analyses. See the Project B [Plan page](plan.qmd) in these instructions for more on creating appropriate research questions.
...
The [2025 CHR Technical Document](https://www.countyhealthrankings.org/sites/default/files/media/document/2025%20CHRR%20Technical%20Document_1.pdf) file (PDF), and the [2025 Data Dictionary](https://www.countyhealthrankings.org/sites/default/files/media/document/DataDictionary_2025.pdf) file (also PDF) are crucial here, as those are the ones that explain what the available variables mean, and how they should be labeled. 

- In building your codebook for the Project B Plan, you will also need look up each measure you select at [this CHR 2025 Measures link](https://www.countyhealthrankings.org/health-data/county-health-rankings-measures), so now would be a good time to do that, as well.
...
- A serious look at the impact of race/ethnicity is beyond the scope of Project B. If you are interested in studying race and ethnicity and their impact on a health outcome, we suggest using `v126`, (or its inverse, 1 - `v126`), to incorporate this dimension as a predictor. This is because there's more variation in the `v126` data across the reported counties than other variables describing race or ethnicity. 
...
Assuming you have placed the `431-projectA-chr_2019.csv` file in your R Project directory for Project B, then the following code should pull in the information you'll need into a tibble.
...
County Health Rankings data for variables reported in CHR 2019 eligible for use in Project B Analysis 3 are listed below, with their descriptions, including the source and year(s) in which they were gathered. Please incorporate this information into your codebook.
...
Save this final **chr_2025** tibble with 11 variables as an R data set (.Rds file) in your R Project, with the file name **chr_2025_YOURNAME.Rds**. You will share this file with us as part of your Project B Plan. If you like, you can store this `.Rds` file in a `data` subdirectory within your R Project.
